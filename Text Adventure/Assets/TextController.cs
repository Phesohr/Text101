...
public class TextController : MonoBehaviour {
	...
	void Update () {
		...
		else if (myState == States.lock_0) 		{state_lock_1 ();} 
	...
	void state_sheets_1() {
		text.text = "Holding a mirror in your hand doesn't the sheets look " +
					"any better.n\n" +
					"Press R to Return to roaming your cell";
	...
	void state_lock_0 () {
		text.text = "This is one of thsoe button locks. You have no idea what the " +
					...
					"Ifingerprints were, maybe that would help. \n\n" +
					"Press R to Return to roaming your cell";
		if (Input.GetKeyDown (KeyCode.R)) 		{myState = States.cell;}
	}
	...
	void state_lock_1 () {
		text.text = "You carefully put the mirror through the bars, and turn it around " +
					"so you can see the lcokm You can just make out the fingerpints around " +
	...
	void state_freedom () {
		text.text = "You are FREE!! Now you can lvie a decent life or continue to be a " +
					"criminal!\n\n" +
